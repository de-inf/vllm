            ...
            if req_state.prev_num_draft_len and self.use_async_scheduling:
                ...
                if req_index is None:
                    ...
                    if prev_req_index is None:
                        req_state.prev_num_draft_len = 0
                    elif prev_req_index >= len(valid_sampled_token_count):
                        msg = (
                        ...
                        if (
                            num_accepted < 0
                            or num_accepted > req_state.prev_num_draft_len
                        ):
                            msg = (
        ...
        if spec_config is not None:
            ...
            if use_gpu_toks:
                ...
                if not input_fits_in_drafter:
                    # Drafter can't run (batch exceeds drafter max_model_len).
                    # Zero draft tokens so the scheduler does not reuse
                    # leftover proposals from a previous step.
